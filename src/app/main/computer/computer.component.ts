...
export class ComputerComponent implements OnInit {
  ...
  public getlistpaging() {
    this._dataService.get(`/api/computer/getlistpaging?pageIndex=${this.pageIndex}&pageSize=${this.pageSize}&computerTypeId=${this.computerTypeId}&deparmentTypeId=${this.deparmentTypeId}&producerTypeId=${this.producerTypeId}&filter=${this.filter}`)
